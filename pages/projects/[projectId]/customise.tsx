...
const ProjectCustomise = (project: any) => {
    ...
    const [ctrlPressing, setCtrlPressing] = React.useState(false);
    ...
    return user ? (
        ...
        >
            ...
            {languages.length ? <div className={"grid grid-cols-1 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-4 xl:grid-cols-6 gap-7 flex-wrap overflow-hidden pb-32"}>
                {languages.map(l => {
                    return (
                        <a 
